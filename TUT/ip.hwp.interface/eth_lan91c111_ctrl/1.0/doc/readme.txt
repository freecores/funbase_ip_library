Simple controller for SMSC LAN91C111. Uses the same interface as
DM9000A controller and can be connected to the UDP/IP controller
...
extra complexity by simplifying the structures I could simplify.
