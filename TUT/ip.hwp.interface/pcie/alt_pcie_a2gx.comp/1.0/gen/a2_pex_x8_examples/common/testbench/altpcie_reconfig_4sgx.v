...
//VERSION_BEGIN 8.1 cbx_alt2gxb_reconfig 2008:08:05:06:24:16:SJ cbx_alt_dprio 2008:07:22:18:38:30:SJ cbx_altsyncram 2008:07:29:14:21:43:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:05:19:10:49:01:SJ cbx_lpm_compare 2008:06:19:01:35:05:SJ cbx_lpm_counter 2008:05:19:10:42:20:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_mux 2008:05:19:10:30:36:SJ cbx_lpm_shiftreg 2008:05:19:10:27:41:SJ cbx_mgl 2008:07:29:10:47:02:SJ cbx_stratix 2008:05:19:10:18:59:SJ cbx_stratixii 2008:05:19:11:00:18:SJ cbx_stratixiii 2008:07:11:13:32:02:SJ cbx_util_mgl 2008:07:18:09:58:54:SJ  VERSION_END
// synthesis VERILOG_INPUT_VERSION VERILOG_2001
// altera message_off 10463



//alt_cal CBX_AUTO_BLACKBOX="ALL" CHANNEL_ADDRESS_WIDTH=3 DEVICE_FAMILY="Stratix IV" NUMBER_OF_CHANNELS=8 SIM_MODEL_MODE="TRUE" busy dprio_addr dprio_busy dprio_data dprio_in dprio_rden dprio_wren reconfig_clk reset testbuses
//VERSION_BEGIN 8.1 cbx_alt2gxb_reconfig 2008:08:05:06:24:16:SJ cbx_alt_dprio 2008:07:22:18:38:30:SJ cbx_altsyncram 2008:07:29:14:21:43:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:05:19:10:49:01:SJ cbx_lpm_compare 2008:06:19:01:35:05:SJ cbx_lpm_counter 2008:05:19:10:42:20:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_mux 2008:05:19:10:30:36:SJ cbx_lpm_shiftreg 2008:05:19:10:27:41:SJ cbx_mgl 2008:07:29:10:47:02:SJ cbx_stratix 2008:05:19:10:18:59:SJ cbx_stratixii 2008:05:19:11:00:18:SJ cbx_stratixiii 2008:07:11:13:32:02:SJ cbx_util_mgl 2008:07:18:09:58:54:SJ  VERSION_END

//synthesis_resources = lpm_add_sub 1 reg 4 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  altpcie_reconfig_4sgx_alt_cal_s7l
	( 
	busy,
	cal_error,
	dprio_addr,
	...
	always @ ( posedge reconfig_clk)
		  sim_counter_reg <= ({4{(~ reset)}} & (({4{(start | ((~ sim_counter_and) & sim_counter_or))}} & sim_counter_next) | ({4{((~ start) & sim_counter_and)}} & hex0)));
	lpm_add_sub   next_scount_num
	( 
	.cout(),
	.dataa(sim_counter_reg),
	.datab(4'b0001),
	.overflow(),
	.result(wire_next_scount_num_result)
	...
	defparam
		next_scount_num.lpm_direction = "ADD",
		next_scount_num.lpm_width = 4,
		next_scount_num.lpm_type = "lpm_add_sub",
		next_scount_num.lpm_hint = "ONE_INPUT_IS_CONSTANT=YES";
	assign
		busy = sim_counter_or,
		cal_error = {8{1'b0}},
		dprio_addr = {16{1'b0}},
		...
		dprio_wren = 1'b0,
		hex0 = {4{1'b0}},
		sim_counter_and = (((sim_counter_reg[3] & sim_counter_reg[2]) & sim_counter_reg[1]) & sim_counter_reg[0]),
		sim_counter_next = wire_next_scount_num_result,
		sim_counter_or = (((sim_counter_reg[3] | sim_counter_reg[2]) | sim_counter_reg[1]) | sim_counter_reg[0]),
		start = 1'b0;
endmodule //altpcie_reconfig_4sgx_alt_cal_s7l


//alt_dprio address_width=16 CBX_AUTO_BLACKBOX="ALL" device_family="Stratix IV" quad_address_width=7 address busy datain dataout dpclk dpriodisable dprioin dprioload dprioout quad_address rden wren
//VERSION_BEGIN 8.1 cbx_alt_dprio 2008:07:22:18:38:30:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:05:19:10:49:01:SJ cbx_lpm_compare 2008:06:19:01:35:05:SJ cbx_lpm_counter 2008:05:19:10:42:20:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_shiftreg 2008:05:19:10:27:41:SJ cbx_mgl 2008:07:29:10:47:02:SJ cbx_stratix 2008:05:19:10:18:59:SJ cbx_stratixii 2008:05:19:11:00:18:SJ  VERSION_END
...
module  altpcie_reconfig_4sgx_alt_dprio_8ei
	( 
	address,
	busy,
	datain,
...
endmodule //altpcie_reconfig_4sgx_alt_dprio_8ei

//synthesis_resources = lpm_add_sub 5 lpm_compare 7 lpm_counter 4 lpm_decode 3 lpm_mux 2 lut 1 reg 150 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
...
module  altpcie_reconfig_4sgx_alt2gxb_reconfig_77s1
	...
	wire  [7:0]   wire_calibration_cal_error;
	wire  [15:0]   wire_calibration_dprio_addr;
	wire  [15:0]   wire_calibration_dprio_data;
	...
	wire  tx_reconfig;
	wire  [8:0]  w220w;
	wire  [2:0]  w_rx_eqa397w;
	wire  [2:0]  w_rx_eqb396w;
	wire  [2:0]  w_rx_eqc395w;
	wire  [2:0]  w_rx_eqd394w;
	wire  [2:0]  w_rx_eqv398w;
	wire  wr_pulse;
	wire  write_addr_inc;
	...
	altpcie_reconfig_4sgx_alt_cal_s7l   calibration
	( 
	.busy(wire_calibration_busy),
	.cal_error(wire_calibration_cal_error),
	.dprio_addr(wire_calibration_dprio_addr),
	.dprio_busy(wire_dprio_busy),
	.dprio_data(wire_calibration_dprio_data),
	.dprio_in(wire_dprio_dataout),
	...
	altpcie_reconfig_4sgx_alt_dprio_8ei   dprio
	( 
	...
	.datain((({16{wire_calibration_busy}} & wire_calibration_dprio_data) | ({16{(~ wire_calibration_busy)}} & a2gr_dprio_data))),
	...
	// synopsys translate_on
	always @ ( posedge reconfig_clk)
		  address_pres_reg <= {quad_address, 1'b0, channel_address};
	// synopsys translate_off
	initial
		data_valid_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_rx_eqctrl_reg_d = (({4{read_state}} & (((({{2{1'b0}}, (w_rx_eqv398w[2] & (~ (w_rx_eqv398w[1] ^ w_rx_eqv398w[0]))), (((w_rx_eqv398w[2] & w_rx_eqv398w[1]) & w_rx_eqv398w[0]) | (((~ w_rx_eqv398w[2]) & (~ w_rx_eqv398w[1])) & (~ w_rx_eqv398w[0])))} & {4{(((((w_rx_eqd394w[2] & w_rx_eqd394w[1]) & w_rx_eqd394w[0]) & (~ ((w_rx_eqc395w[2] & w_rx_eqc395w[1]) & w_rx_eqc395w[0]))) & (~ ((w_rx_eqb396w[2] & w_rx_eqb396w[1]) & w_rx_eqb396w[0]))) & (~ ((w_rx_eqa397w[2] & w_rx_eqa397w[1]) & w_rx_eqa397w[0])))}}) | ({1'b0, 1'b1, ((w_rx_eqv398w[2] & w_rx_eqv398w[1]) & w_rx_eqv398w[0]), ((w_rx_eqv398w[2] & (~ w_rx_eqv398w[1])) & (~ w_rx_eqv398w[0]))} & {4{(((((w_rx_eqd394w[2] & w_rx_eqd394w[1]) & w_rx_eqd394w[0]) & ((w_rx_eqc395w[2] & w_rx_eqc395w[1]) & w_rx_eqc395w[0])) & (~ ((w_rx_eqb396w[2] & w_rx_eqb396w[1]) & w_rx_eqb396w[0]))) & (~ ((w_rx_eqa397w[2] & w_rx_eqa397w[1]) & w_rx_eqa397w[0])))}})) | ({w_rx_eqv398w[2], (~ w_rx_eqv398w[2]), (((w_rx_eqv398w[2] & w_rx_eqv398w[1]) & w_rx_eqv398w[0]) | (((~ w_rx_eqv398w[2]) & (~ w_rx_eqv398w[1])) & (~ w_rx_eqv398w[0]))), ((~ w_rx_eqv398w[1]) & (~ (w_rx_eqv398w[2] ^ w_rx_eqv398w[0])))} & {4{(((((w_rx_eqd394w[2] & w_rx_eqd394w[1]) & w_rx_eqd394w[0]) & ((w_rx_eqc395w[2] & w_rx_eqc395w[1]) & w_rx_eqc395w[0])) & ((w_rx_eqb396w[2] & w_rx_eqb396w[1]) & w_rx_eqb396w[0])) & (~ ((w_rx_eqa397w[2] & w_rx_eqa397w[1]) & w_rx_eqa397w[0])))}})) | ({1'b1, ((w_rx_eqv398w[2] | w_rx_eqv398w[1]) | w_rx_eqv398w[0]), (((~ w_rx_eqv398w[1]) & (~ (w_rx_eqv398w[2] ^ w_rx_eqv398w[0]))) | ((w_rx_eqv398w[2] & w_rx_eqv398w[1]) & w_rx_eqv398w[0])), (((~ w_rx_eqv398w[1]) & (~ w_rx_eqv398w[0])) | ((w_rx_eqv398w[2] & w_rx_eqv398w[1]) & w_rx_eqv398w[0]))} & {4{(((((w_rx_eqd394w[2] & w_rx_eqd394w[1]) & w_rx_eqd394w[0]) & ((w_rx_eqc395w[2] & w_rx_eqc395w[1]) & w_rx_eqc395w[0])) & ((w_rx_eqb396w[2] & w_rx_eqb396w[1]) & w_rx_eqb396w[0])) & ((w_rx_eqa397w[2] & w_rx_eqa397w[1]) & w_rx_eqa397w[0]))}}))) | ({4{write_state}} & rx_eqctrl));
	assign
	...
	assign
		wire_rx_equalizer_dcgain_reg_d = (({3{read_state}} & {wire_dprio_dataout[10], (wire_dprio_dataout[8] & (~ wire_dprio_dataout[10])), (wire_dprio_dataout[7] & (~ wire_dprio_dataout[10]))}) | ({3{write_state}} & rx_eqdcgain));
	assign
	...
	assign
		wire_tx_vodctrl_reg_d = (({3{read_state}} & wire_dprio_dataout[15:13]) | ({3{write_state}} & tx_vodctrl));
	assign
	...
	always @ ( posedge reconfig_clk)
		if (wire_wr_rd_pulse_reg_ena == 1'b1) 
			if (reset_system == 1'b1) wr_rd_pulse_reg <= 1'b0;
	...
	assign
		...
		dprio_datain_64_67 = {wire_dprio_dataout[15:11], {rx_eqdcgain[2], (rx_eqdcgain[2] | (rx_eqdcgain[1] & rx_eqdcgain[0])), (rx_eqdcgain[2] | rx_eqdcgain[1]), (rx_eqdcgain[2] | rx_eqdcgain[0])}, wire_dprio_dataout[6:0]},
		...
		dprio_datain_vodctrl = {tx_vodctrl, wire_dprio_dataout[12:0]},
		...
		illegal_rd_mode_type = (((~ reconfig_mode_sel[2]) & ((~ reconfig_mode_sel[1]) & (~ reconfig_mode_sel[0]))) | ((reconfig_mode_sel[1] & reconfig_mode_sel[0]) & (~ (rate_switch_ctrl[1] & rate_switch_ctrl[0])))),
		illegal_wr_mode_type = ((reconfig_mode_sel[2] & (~ (reconfig_mode_sel[1] & reconfig_mode_sel[0]))) | ((~ reconfig_mode_sel[2]) & (~ (((reconfig_mode_sel[1] & reconfig_mode_sel[0]) & (rate_switch_ctrl[1] & rate_switch_ctrl[0])) | (reconfig_mode_sel[1] & (~ reconfig_mode_sel[0])))))),
		...
		quad_address = {6'b000000, wire_addr_cntr_q[2]},
		quad_address_out = address_pres_reg[9:3],
		rate_switch_ctrl = {2{1'b0}},
		rd_pulse = ((((((~ dprio_pulse) & (~ write_done)) & (~ wr_rd_pulse_reg)) & (write_state & (((~ header_proc) & (~ reset_reconf_addr)) & (~ is_tier_1)))) | ((read_state & (~ dprio_pulse)) & (~ read_done))) & (~ is_illegal_reg_d)),
		...
		w220w = {quad_address, channel_address},
		w_rx_eqa397w = wire_dprio_dataout[14:12],
		w_rx_eqb396w = wire_dprio_dataout[11:9],
		w_rx_eqc395w = wire_dprio_dataout[8:6],
		w_rx_eqd394w = wire_dprio_dataout[5:3],
		w_rx_eqv398w = wire_dprio_dataout[2:0],
		wr_pulse = ((((write_state & (~ dprio_pulse)) & (~ write_done)) & ((wr_rd_pulse_reg & (((~ is_tier_1) | is_end_mif) | is_pll_addr)) | ((is_tier_1 & (~ header_proc)) & (~ reset_reconf_addr)))) & (~ is_illegal_reg_d)),
