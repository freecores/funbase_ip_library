...
//
// 9.0 Internal Build 215 05/06/2009 SP 2 SJ Full Version
// ************************************************************
...
//VERSION_BEGIN 9.0SP2 cbx_alt2gxb_reconfig 2009:05:04:09:24:31:SJ cbx_alt_cal 2009:04:27:08:43:10:SJ cbx_alt_dprio 2008:07:22:18:38:30:SJ cbx_altsyncram 2009:04:03:15:10:30:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:12:09:22:11:50:SJ cbx_lpm_compare 2009:02:03:01:43:16:SJ cbx_lpm_counter 2008:05:19:10:42:20:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_mux 2009:03:31:01:01:28:SJ cbx_lpm_shiftreg 2008:05:19:10:27:41:SJ cbx_mgl 2009:02:26:16:06:21:SJ cbx_stratix 2008:09:18:16:08:35:SJ cbx_stratixii 2008:11:14:16:08:42:SJ cbx_stratixiii 2008:12:24:11:49:14:SJ cbx_util_mgl 2008:11:21:14:58:47:SJ  VERSION_END
...
//VERSION_BEGIN 9.0SP2 cbx_alt_dprio 2008:07:22:18:38:30:SJ cbx_cycloneii 2008:05:19:10:57:37:SJ cbx_lpm_add_sub 2008:12:09:22:11:50:SJ cbx_lpm_compare 2009:02:03:01:43:16:SJ cbx_lpm_counter 2008:05:19:10:42:20:SJ cbx_lpm_decode 2008:05:19:10:39:27:SJ cbx_lpm_shiftreg 2008:05:19:10:27:41:SJ cbx_mgl 2009:02:26:16:06:21:SJ cbx_stratix 2008:09:18:16:08:35:SJ cbx_stratixii 2008:11:14:16:08:42:SJ  VERSION_END
...
`endif
	...
	wire  [6:0]   wire_calibration_quad_addr;
	...
	wire  tx_reconfig;
	wire  [8:0]  w263w;
	wire  [2:0]  w_rx_eqa460w;
	wire  [2:0]  w_rx_eqb459w;
	wire  [2:0]  w_rx_eqc458w;
	wire  [2:0]  w_rx_eqd457w;
	wire  [2:0]  w_rx_eqv461w;
	wire  wr_pulse;
	wire  write_addr_inc;
	...
	always @ ( posedge reconfig_clk)
		  address_pres_reg <= {(({7{cal_busy}} & cal_quad_address) | ({7{(~ cal_busy)}} & quad_address)), ((cal_busy & cal_channel_address[2]) | ((~ cal_busy) & pll_address)), (({2{cal_busy}} & cal_channel_address[1:0]) | ({2{(~ cal_busy)}} & ((channel_address & {2{(~ pll_address)}}) | (pll_sel_num & {2{pll_address}}))))};
	// synopsys translate_off
	initial
		data_valid_reg = 0;
	// synopsys translate_on
	...
	assign
		wire_rx_eqctrl_reg_d = (({4{read_state}} & (((({{2{1'b0}}, (w_rx_eqv461w[2] & (~ (w_rx_eqv461w[1] ^ w_rx_eqv461w[0]))), (((w_rx_eqv461w[2] & w_rx_eqv461w[1]) & w_rx_eqv461w[0]) | (((~ w_rx_eqv461w[2]) & (~ w_rx_eqv461w[1])) & (~ w_rx_eqv461w[0])))} & {4{(((((w_rx_eqd457w[2] & w_rx_eqd457w[1]) & w_rx_eqd457w[0]) & (~ ((w_rx_eqc458w[2] & w_rx_eqc458w[1]) & w_rx_eqc458w[0]))) & (~ ((w_rx_eqb459w[2] & w_rx_eqb459w[1]) & w_rx_eqb459w[0]))) & (~ ((w_rx_eqa460w[2] & w_rx_eqa460w[1]) & w_rx_eqa460w[0])))}}) | ({1'b0, 1'b1, ((w_rx_eqv461w[2] & w_rx_eqv461w[1]) & w_rx_eqv461w[0]), ((w_rx_eqv461w[2] & (~ w_rx_eqv461w[1])) & (~ w_rx_eqv461w[0]))} & {4{(((((w_rx_eqd457w[2] & w_rx_eqd457w[1]) & w_rx_eqd457w[0]) & ((w_rx_eqc458w[2] & w_rx_eqc458w[1]) & w_rx_eqc458w[0])) & (~ ((w_rx_eqb459w[2] & w_rx_eqb459w[1]) & w_rx_eqb459w[0]))) & (~ ((w_rx_eqa460w[2] & w_rx_eqa460w[1]) & w_rx_eqa460w[0])))}})) | ({w_rx_eqv461w[2], (~ w_rx_eqv461w[2]), (((w_rx_eqv461w[2] & w_rx_eqv461w[1]) & w_rx_eqv461w[0]) | (((~ w_rx_eqv461w[2]) & (~ w_rx_eqv461w[1])) & (~ w_rx_eqv461w[0]))), ((~ w_rx_eqv461w[1]) & (~ (w_rx_eqv461w[2] ^ w_rx_eqv461w[0])))} & {4{(((((w_rx_eqd457w[2] & w_rx_eqd457w[1]) & w_rx_eqd457w[0]) & ((w_rx_eqc458w[2] & w_rx_eqc458w[1]) & w_rx_eqc458w[0])) & ((w_rx_eqb459w[2] & w_rx_eqb459w[1]) & w_rx_eqb459w[0])) & (~ ((w_rx_eqa460w[2] & w_rx_eqa460w[1]) & w_rx_eqa460w[0])))}})) | ({1'b1, ((w_rx_eqv461w[2] | w_rx_eqv461w[1]) | w_rx_eqv461w[0]), (((~ w_rx_eqv461w[1]) & (~ (w_rx_eqv461w[2] ^ w_rx_eqv461w[0]))) | ((w_rx_eqv461w[2] & w_rx_eqv461w[1]) & w_rx_eqv461w[0])), (((~ w_rx_eqv461w[1]) & (~ w_rx_eqv461w[0])) | ((w_rx_eqv461w[2] & w_rx_eqv461w[1]) & w_rx_eqv461w[0]))} & {4{(((((w_rx_eqd457w[2] & w_rx_eqd457w[1]) & w_rx_eqd457w[0]) & ((w_rx_eqc458w[2] & w_rx_eqc458w[1]) & w_rx_eqc458w[0])) & ((w_rx_eqb459w[2] & w_rx_eqb459w[1]) & w_rx_eqb459w[0])) & ((w_rx_eqa460w[2] & w_rx_eqa460w[1]) & w_rx_eqa460w[0]))}}))) | ({4{write_state}} & rx_eqctrl));
	assign
	...
	assign
		...
		w263w = {quad_address, channel_address},
		w_rx_eqa460w = wire_dprio_dataout[14:12],
		w_rx_eqb459w = wire_dprio_dataout[11:9],
		w_rx_eqc458w = wire_dprio_dataout[8:6],
		w_rx_eqd457w = wire_dprio_dataout[5:3],
		w_rx_eqv461w = wire_dprio_dataout[2:0],
